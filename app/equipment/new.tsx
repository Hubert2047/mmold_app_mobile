import { addEquipment, CATEGORY_OPTIONS, PHASE_OPTIONS } from '@/src/data/equipment'
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.title}>{t('equipment.newTitle', '新增設備')}</Text>
                <View style={{ width: 22 }} />
            </View>
            ...
            <ScrollView contentContainerStyle={styles.form} showsVerticalScrollIndicator={false}>
                ...
                <TextInput
                    ...
                    placeholder={t('equipment.namePlaceholder', '例如：2號CNC成型機')}
